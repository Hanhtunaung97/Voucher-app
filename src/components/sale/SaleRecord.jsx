  ...
  return (
    <tr className="group odd:bg-white odd:dark:bg-gray-900 even:bg-blue-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
      ...
      <td className="px-6 py-4 text-end">
        ...
        >
          <HiMinusSmall className="w-4 h-4 pointer-events-none" />
        </button>
        ...
        >
          <HiMiniPlusSmall className="w-4 h-4 pointer-events-none" />
        </button>
      </td>
      <td className="px-6 py-4 text-end ">
      ...
      <td className="px-2 py-4 flex justify-end">
        ...
        >
          {isDelete ? (
            ...
            <CiTrash className="w-4 h-4 duration-100 group-hover:w-5 group-hover:h-5 pointer-events-none*" />
          )}
        </button>
      </td>
